  ...
  const values = [
    {
      ...
      description:
        "10+ years in immunology, oncology, and AI-driven drug discovery at Generate Biomedicines, Novartis, and Juno",
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20">
      ...
      description:
        "Cross-functional leader bridging R&D and strategy—from AI/ML requirements to go/no-go decisions",
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Why Biotech Needs Scientist-Investors
          </h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            The best investment decisions come from understanding both the biology and the business
          </p>
        </div>
