...
export default function FeaturedProjects() {
  const multiAgentProject = {
    ...
    description: "Experience how 5 specialized AI agents powered by different models (Claude Sonnet 4, Gemini Pro, Perplexity Sonar Pro) work together to analyze complex biotech scenarios. Upload documents and watch as Clinical, Patent, Financial, Market Research, and Regulatory experts collaborate in real-time to provide comprehensive due diligence.",
