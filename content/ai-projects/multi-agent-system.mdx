...
title: "Sonny: Multi-Agent Intelligence System"
subtitle: "5 Specialized AI Agents Working in Concert"
description: "Experience how Sonny orchestrates 5 specialized AI agents to analyze complex biotech scenarios across clinical, patent, financial, market research, and regulatory dimensions. Powered by Claude Sonnet 4, Gemini 2.0 Flash, and Perplexity Sonar Pro."
...
**Output:** Sonny lays out the case for and against, with the deal terms each side implies
...
4. Watch Sonny orchestrate agents in real-time
