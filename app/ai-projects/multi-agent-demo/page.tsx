...
export const metadata: Metadata = {
  ...
  description: 'Experience how 5 specialized AI agents powered by different models (Claude Sonnet 4, Gemini Pro, Perplexity Sonar Pro) collaborate to analyze complex biotech scenarios across clinical, patent, financial, market research, and regulatory dimensions.',
