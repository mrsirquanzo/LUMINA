  ...
  const chatSection = (
    <div className="flex gap-3">
      <input
        ...
        className="flex-1 px-4 py-2 rounded-lg bg-white/5 border border-border text-textPrimary placeholder-gray-500 focus:outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20"
      />
      <button
