import type { ProcessedDocument, CostEstimate, ExecutionMode, AgentType } from './multiAgentTypes';
...
export function estimateMultiAgentCost(
  ...
  if (mode === 'fast') {
    ...
    const agents: AgentType[] = ['clinical', 'patent', 'financial', 'regulatory', 'market_research', 'target_biology'];
